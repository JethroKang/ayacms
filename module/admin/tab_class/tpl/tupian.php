...
<div class="form-group">
	<label for="tab_biaoti" class="col-sm-2 control-label">最少图片</label>
	<div class="col-sm-5">
		<input type="text" class="form-control" id="conf[0]" name="conf[0]"
			placeholder="整数,0代表可以不上传" value="">
	</div>
</div>

<div class="form-group">
	<label for="tab_biaoti" class="col-sm-2 control-label">最多图片</label>
	<div class="col-sm-5">
		<input type="text" class="form-control" id="conf[1]" name="conf[1]"
			placeholder="整数" value="">
	</div>
</div>
...
<div class="form-group">
    ...
    <label for="tab_biaoti" class="col-sm-2 control-label">最少图片</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" id="conf[0]" name="conf[0]" placeholder="整数,0代表可以为空" value="<?php echo $tab['conf'][0]?>">
    </div>
  </div>
    ...
    <label for="tab_biaoti" class="col-sm-2 control-label">最多图片</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" id="conf[1]" name="conf[1]" placeholder="整数" value="<?php echo $tab['conf'][1]?>">
    </div>
  </div>
