		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				...
				<input type="text" class="form-control" id="keywords"
					name="keywords" placeholder="多关键字用,分隔" value="">
			</div>
		</div>
...
<div class="form-group">
		...
		<option value="<?php echo $k2+1?>"><?php echo html($v2)?></option>
...
<?php
		...
		?>
			...
			<div class="col-sm-5">
<?php echo init_uploads('pics','jpg,jpge,gif,png')?>	
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				...
				<textarea name="content" class="" id="content">
</textarea>
				<p class="help-block"></p>
			</div>
		</div>
  
<?php echo ini_editor('content',$formid,'300')?>  
	
		<div class="form-group">
			<label class="col-sm-2 control-label">分页标题</label>
			<div class="col-sm-5">
				<textarea class="form-control" id="pagetitles" cols="" rows=""
					name="pagetitles" placeholder="每行一个分标题"></textarea>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				...
				<div class="checkbox">
					<label>
						<input type="checkbox" value="1" name="tuijian" />
					</label>
				</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<?php echo init_upload('thumb','jpg,jpge,gif,png','')?>
			</div>
		</div>		
		
<?php echo tab::tpls ( $channel['tabs']['diss'],'form_edit.php',array())?>	
