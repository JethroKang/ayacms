...
'上海'=>array('黄浦','卢湾','徐汇','长宁','静安','普陀','闸北','虹口','杨浦','闵行','宝山','嘉定','浦东','金山','松江','青浦','南汇','奉贤','崇明'),
'天津'=>array('和平','东丽','河东','西青','河西','津南','南开','北辰','河北','武清','红挢','塘沽','汉沽','大港','宁河','静海','宝坻','蓟县'),
...
'内蒙古'=>array('呼和浩特','包头','乌海','赤峰','呼伦贝尔盟','阿拉善盟','哲里木盟','兴安盟','乌兰察布盟','锡林郭勒盟','巴彦淖尔盟','伊克昭盟'),
...
'广西'=>array('南宁','柳州','桂林','梧州','北海','防城港','钦州','贵港','玉林','南宁地区','柳州地区','贺州','百色','河池'),
'海南'=>array('海口','三亚'),
...
'宁夏'=>array('银川','石嘴山','吴忠','固原'),
'青海'=>array('西宁','海东','海南','海北','黄南','玉树','果洛','海西'),
'新疆'=>array('乌鲁木齐','石河子','克拉玛依','伊犁','巴音郭勒','昌吉','克孜勒苏柯尔克孜','博尔塔拉','吐鲁番','哈密','喀什','和田','阿克苏'),
'香港'=>array('香港'),
'澳门'=>array('澳门'),
'台湾'=>array('台北','高雄','台中','台南','屏东','南投','云林','新竹','彰化','苗栗','嘉义','花莲','桃园','宜兰','基隆','台东','金门','马祖','澎湖'),
'其它'=>array('北美洲','南美洲','亚洲','非洲','欧洲','大洋洲'),
);